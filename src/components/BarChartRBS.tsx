...
function ChartEmptyState() {
  return (
    ...
    >
      ...
      >
        Add your first blood sugar reading to see the bar chart.
      </span>
    </div>
  )
}

export function BarChartRBS({ readings, loading = false }: BarChartRBSProps) {
  ...
  return (
    <div
      role="img"
      aria-label="Bar chart comparing fasting, post-meal, and night blood sugar readings by date"
      style={{ width: '100%', height: '300px' }}
    >
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={data} margin={{ top: 8, right: 24, left: 0, bottom: 8 }} barGap={3} barCategoryGap="28%">
          ...
          <Bar dataKey="Fasting" fill={fastingColor} radius={[4, 4, 0, 0]} maxBarSize={28} />
          <Bar dataKey="Post-Meal" fill={postMealColor} radius={[4, 4, 0, 0]} maxBarSize={28} />
          <Bar dataKey="Night" fill={nightColor} radius={[4, 4, 0, 0]} maxBarSize={28} />
        </BarChart>
      </ResponsiveContainer>
    </div>
  )
